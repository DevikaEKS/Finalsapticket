...
//     }
//     else if (formData.company_short_name==="") {
//       alert("please fill the company short name")

//     }

//     else if ((formData.VAT_number==='') && (formData.gst_no==='')) {
//       alert("please fill the VAT or GST ")
//     }
//     else{

//       axios.post("http://192.168.252.158:5000/api/client/register", formData)
//         .then(res => {
//           console.log(res);
...
function ClientRegister() {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      axios.post("http://192.168.185.97:5000/api/client/register", formData)
        .then(res => {
          console.log(res);
          const clientId = res.data.clientId;
          if (res.data.message === "Client created successfully and password sent via email.") {
