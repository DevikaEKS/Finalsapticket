...
// //   useEffect(() => {
// //     axios
// //       .get(`http://192.168.252.158:5000/api/serve/${client_id}/services`)
// //       .then((res) => {
...
// //         `http://localhost:5000/api/tickets/create/${company_name}/${company_short_name}`, {subject,ticket_body:ticketBody,client_id,subdivision_id:project},
// //         {
// //           headers: {
...
//     // try {
//     //   const response = await axios.post(
//     //     `http://localhost:5000/api/tickets/create/${company_name}/${company_short_name}`,
//     //     formDataToSend,
//     //     {
//     //       headers: {
//     //         'Content-Type': 'multipart/form-data',
...
const TicketForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://192.168.252.158:5000/api/tickets/create/${company_name}/${company_short_name}`,
        formDataToSend,
        {
          headers: {
            "Content-Type": "multipart/form-data",
    ...
    <div className={styles.ticketFormContainer}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input type="file" name="screenshot" onChange={handleFileChange} />
        </div>
